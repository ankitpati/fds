...
/* quick sort */
void qikswap(int *a, size_t i, size_t j)
{
    int  temp;
    temp=a[i];
    a[i]=a[j];
...
int qikpart(int *a, size_t left, size_t right)
{
    size_t ileft;
    int piv;
...
void qikcore(int *a, size_t left, size_t right)
{
    size_t last;
